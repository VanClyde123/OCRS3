            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-inline mb-2">
                        <form action="{{ route('secretary.searchPastInstructorSubjects', ['instructorId' => $instructor->id]) }}" method="GET" class="mb-2 mr-2 form-inline">
                                ...
                                <tbody id="subject-table-body">
                                    @foreach($pastSubjects as $subject)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('secretary.teacher_list.enrolled_students', ['subject' => $subject->subject->id]) }}" class="btn btn-info">View Enrolled Students</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
