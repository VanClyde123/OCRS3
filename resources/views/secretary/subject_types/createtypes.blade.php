                        ...
                        <div class="card-body">
                            <form action="{{ route('subject_types.store1') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lec_percentage" min="0.01"step="0.1" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lab_percentage" min="0.01"step="0.1" class="form-control" required>
