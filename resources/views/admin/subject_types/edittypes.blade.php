        ...
        <section class="content">
            <div class="card">                
                <div class="card-header">
                    <h3 class="card-title">Edit {{ $subjectType->subject_type }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('subject_types.update', $subjectType->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="lec_percentage" min="0.00" max="1" step="0.1" class="form-control" value="{{ $subjectType->lec_percentage  }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="lab_percentage" min="0.00" max="1" step="0.1" class="form-control" value="{{ $subjectType->lab_percentage  }}" required>
