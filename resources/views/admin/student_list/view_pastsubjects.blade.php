            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <div>
                            <form action="{{ route('admin.viewPastEnrolledSubjects', ['studentId' => $student->id]) }}" method="GET" class=" mb-2 form-inline">
                                ...
                                <tbody>
                                    @foreach($pastEnrolledSubjects as $subject)
                                        <tr>
                                            ...
                                            <td>{{ $subject->term }}</td>
                                            <td><a href="{{ route('admin.viewGrades', ['studentId' => $student->id, 'subjectId' => $subject->id]) }}" class="btn btn-info">View Scores and Grades</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
