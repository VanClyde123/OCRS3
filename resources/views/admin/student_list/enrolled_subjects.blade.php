    ...
    <div class="content-wrappers">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        <form action="{{ route('admin.searchEnrolledSubjects', ['studentId' => $student->id]) }}" method="GET" class="mb-2">
                            ...
                            <tbody>
                                @foreach($enrolledSubjects as $subject)
                                    <tr>
                                        ...
                                        <td>{{ $subject->term }}</td>
                                        <td>
                                            <a href="{{ route('admin.viewGrades', ['studentId' => $student->id, 'subjectId' => $subject->id]) }}" class="btn btn-info">View Scores and Grades</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
