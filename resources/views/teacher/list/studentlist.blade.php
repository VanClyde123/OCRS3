...
@section('content')
    ...
    <div class="content-wrappers">
        <section class="content-header">
            @if($isPastSubjectList)
                <h2>Past Subject Details</h2>  
            @else
                <h2>Class List Details</h2>
            @endif
        </section>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <button type="button" class="btn btn-primary" id="assessmentModalButton" data-toggle="modal" data-target="#assessmentModal" {{ $isPastSubjectList ? 'disabled' : '' }}>Add Assessment</button>
                        ...
                        <form action="{{ route('insert.scores') }}" method="post">
                                                        ...
                                                        foreach ($gradingPeriods as $gradingPeriod) {
                                                            foreach ($assessmentTypes as $assessmentType) {
                                                                ...
                                                                foreach ($gradingPeriodAssessments as $assessment) {
                                                                    ...
                                                                    <input type="text" name="' . $textboxName . '" class="form-control" ' . $disabled . '
                                                                        data-grading-period="' . $assessment->grading_period . '"
                                                                        data-type="' . $assessment->type . '"
                                                                        value="' . $textboxValue . '"
                            ...
                            <a href="{{ $isPastSubjectList ? 'javascript:void(0);' : route('teacher.list.studentlistremove', ['subjectId' => $subject->id]) }}" class="btn btn-info{{ $isPastSubjectList ? ' disabled' : '' }}">View Student List</a>
