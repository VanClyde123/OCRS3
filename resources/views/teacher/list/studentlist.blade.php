                ...
                <div class="table-responsive">
                    <div class="card-body">
                        ...
                        <form action="{{ route('insert.scores') }}" method="post">
                            ...
                            <a href="{{ $isPastSubjectList ? 'javascript:void(0);' : route('teacher.list.studentlistremove', ['subjectId' => $subject->id]) }}" class="btn btn-primary{{ $isPastSubjectList ? ' disabled' : '' }}">View Student List</a>
